...
class GameplayTests(unittest.TestCase):
    def test_basic_bots(self):
        host = AsyncHost({
            ...
            "racist_priority_bot_mech": PriorityFunctions.racist_priority_bot(3, EarlyGameBot,
                                                                              MONSTER_TYPES.MECH),
            "racist_priority_bot_murloc": PriorityFunctions.racist_priority_bot(4, EarlyGameBot,
                                                                                MONSTER_TYPES.MURLOC),
            "priority_adaptive_tripler_bot": PriorityFunctions.priority_adaptive_tripler_bot(5,
                                                                                             EarlyGameBot),
