...
from hearthstone.monster_types import MONSTER_TYPES.MURLOC, MONSTER_TYPES.BEAST, MONSTER_TYPES.DRAGON, MONSTER_TYPES.DEMON, MONSTER_TYPES.PIRATE, MONSTER_TYPES.MECH, MONSTER_TYPES
